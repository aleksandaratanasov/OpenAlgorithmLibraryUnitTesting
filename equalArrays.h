...
bool equal(const std::array<T,S> &v1, const std::array<T, S> &v2) {
  typename std::array<T,S>::const_iterator it1 = v1.begin();
  typename std::array<T,S>::const_iterator it2 = v2.begin();
